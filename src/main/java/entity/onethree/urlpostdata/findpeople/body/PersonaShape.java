...
public class PersonaShape {
    ...
    private List<entity.onethree.urlpostdata.findpeople.body.AdditionalProperties> additionalProperties = new ArrayList<entity.onethree.urlpostdata.findpeople.body.AdditionalProperties>();

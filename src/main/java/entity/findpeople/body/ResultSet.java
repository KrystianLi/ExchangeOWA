...
public class ResultSet {
    ...
    public entity.findpeople.body.EmailAddress getEmailAddress() {
        return EmailAddress;
    }

    public void setEmailAddress(entity.findpeople.body.EmailAddress emailAddress) {
        EmailAddress = emailAddress;
    }

    public List<entity.findpeople.body.EmailAddress> getEmailAddresses() {
        return EmailAddresses;
    }

    public void setEmailAddresses(List<entity.findpeople.body.EmailAddress> emailAddresses) {
    ...
    public List<entity.findpeople.body.AttributionsArray> getAttributionsArray() {
        return AttributionsArray;
    }

    public void setAttributionsArray(List<entity.findpeople.body.AttributionsArray> attributionsArray) {

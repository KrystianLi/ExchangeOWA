...
public class Exchange2018 extends ExchangeStrategy {
    ...
    public Exchange2018(LinkedHashMap<String,String> headerMap, String responseBody, ApiListTree apiListTree, List<ApiTreeModel> subApiTableData, IHttpRequestResponse messageInfo){
    ...
    public void findPeople(){
        try {
            BurpExtender.main.getResultTextArea().append("findPeople Scanning……\n");
            ...
            int count = (int) (totalNumberOfPeopleInView / MaxEntriesReturned);
            ...
            for (int i = 0,offset = 0; i <= count; i++,offset+=MaxEntriesReturned) {
                ...
                headerMap.put("X-Owa-Urlpostdata",s);
